...
void Renderer::fillTriangle(const Point &p1, const Point &p2, const Point &p3, int color)
{
...
void Renderer::fillTriangle(const Triangle &triangle, int color)
{
    fillTriangle(triangle.p1, triangle.p2, triangle.p3, color);
}
